...
const HomeLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navbar */}
      <nav className="sticky top-0 left-0 z-10 bg-white px-[24px] h-[57px] w-full flex items-center border-b-[1px]">
        <div className="flex flex-1 items-center gap-8">
          ...
          {!pathname.includes(ROUTES.BLOG_WRITE) && (
            <div className="hidden md:flex relative z-10 h-[40px] items-center gap-4 px-4 rounded-[20px] bg-gray-50">
              <div className="ca cb n">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <input
                ...
                value={searchQuery}
                className="py-[10px] pr-[20px] bg-transparent border-none focus:outline-none text-sm text-gray-800"
              />
            </div>
          )}
        </div>
        <div className="flex gap-8 items-center">
          {!pathname.includes(ROUTES.BLOG_WRITE) && (
            <Link to={ROUTES.BLOG_WRITE} className="flex gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
      ...
      <div className="w-full flex-1 bg-[#F7F4ED]">
        <Outlet />
      </div>
    </div>
  );
